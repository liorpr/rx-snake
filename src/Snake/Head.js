...
const HeadSvg = ({ style, direction, color }) => (
  <Svg x="0px" y="0px" viewBox="0 0 89 77" direction={direction} style={style}>
    ...
    <TransparentPath color={color} d="M38.2,72.2c0-6.6,5.3-11.9,11.9-11.9s11.9,5.3,11.9,11.9"/>
    <TransparentPath color={color} d="M38.2,7.8c0,6.6,5.3,11.9,11.9,11.9s11.9-5.3,11.9-11.9"/>

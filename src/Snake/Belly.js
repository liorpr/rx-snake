...
const BellySvg = ({ style, color = SOLUTO_BLUE }) => (
  <svg x="0px" y="0px" viewBox="0 0 91 91" style={style}>
    <path fill="#FFFFFF" d="M38.7,87.1c-19.2,0-34.8-15.6-34.8-34.8V38.7c0-19.2,15.6-34.8,34.8-34.8h13.6c19.2,0,34.8,15.6,34.8,34.8
			v13.6c0,19.2-15.6,34.8-34.8,34.8H38.7z"/>
    <path fill={color} d="M52.3,7.9c17,0,30.8,13.8,30.8,30.8v13.6c0,17-13.8,30.8-30.8,30.8H38.7c-17,0-30.8-13.8-30.8-30.8V38.7
    ...
    <Circle fill={color} cx="45.5" cy="45.5" r="33.7"/>
  </svg>
);
